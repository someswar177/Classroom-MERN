    ...
    if (validateForm()) {
      try {
        ...
        if (data.message === "User created successfully") {
          ...
          navigate('/view/teachers');  // Navigate to the view teachers page
        } else {
          ...
          <div className="flex flex-col items-center justify-center px-8 py-8 mx-auto lg:py-0">
            <div className="w-full bg-white rounded-lg md:mt-0 sm:max-w-md xl:p-0">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <p className="text-gray-600 text-center mb-6">Enter teacher details.</p>
                <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                  <div>
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Teacher email</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                  ...
                  <div>
                    <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900">Teacher Password</label>
                    <input
                      type="password"
                      id="password"
                      name="password"
