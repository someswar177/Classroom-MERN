        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
              ...
              <NavLink to="/view/teachers">Teachers</NavLink>
              <NavLink to="/view/classrooms">Classrooms</NavLink>
              <NavLink to="/view/students">Students</NavLink>
              <NavLink to="/view/timetables">Timetables</NavLink>
              {/* <button
